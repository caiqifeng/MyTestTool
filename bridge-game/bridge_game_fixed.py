...
try:
    ...
    pygame.display.set_caption("搭桥专家 - 关卡原型 (修复版)")
...
class GameState:
    ...
    def draw(self):
        ...
        # 使用预加载的字体
        screen.blit(FONT_NORMAL.render("起点", True, (0, 255, 0)), (self.start_pos[0]-20, self.start_pos[1]-30))
        screen.blit(FONT_NORMAL.render("终点", True, (255, 0, 0)), (self.end_pos[0]-20, self.end_pos[1]-30))
    ...
    def draw_ui(self):
        ...
        wood_text = FONT_MEDIUM.render("木材", True, (0, 0, 0))
        steel_text = FONT_MEDIUM.render("钢筋", True, (0, 0, 0))
    ...
    def draw_result(self):
        ...
        hint = FONT_LARGE.render("点击'重新建造'继续挑战", True, (255, 255, 0))
...
def main():
    ...
    try:
        ...
        print(f"游戏运行错误: {e}")
        traceback.print_exc()
        print("请检查依赖是否安装: pip install pygame pymunk")
