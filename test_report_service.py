...
class ReportServiceWebTest(unittest.TestCase):
    ...
    def test_console_html_contains_required_controls(self):
        ...
        self.assertIn("sidebarToggle", html)
        ...
        self.assertIn("/static/nav/lightning.png", html)
        self.assertIn("/static/nav/grid.png", html)
        self.assertIn("/static/nav/history.png", html)
        self.assertIn("/static/nav/clock.png", html)
        self.assertNotIn(".app.sidebar-collapsed .brand-mark", html)
        ...
        self.assertIn("saveFeedbackDialog", html)
        self.assertIn("showSaveFeedback", html)
        self.assertIn("closeSaveFeedback", html)
